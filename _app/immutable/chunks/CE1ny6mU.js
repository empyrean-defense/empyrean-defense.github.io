const e=`# Playtest\r
\r
Welcome to the **Empyrean Defense Playtest**!\r
\r
Thank you for helping test and improve the game before early access release. This page explains how to activate your Playtest key, get started in game, and find answers to common questions.\r
\r
---\r
\r
## How to Activate Your Playtest Key\r
\r
Follow these steps to redeem your Playtest key on Steam:\r
\r
1. **Open Steam.**\r
2. In the top-left menu, click **Games → Activate a Product on Steam…**\r
3. Click **Next**, then **I Agree** to the Steam Subscriber Agreement.\r
4. Enter your unique **Playtest Key** in the text box.\r
5. Steam will automatically add **Empyrean Defense Playtest** to your Library.\r
\r
![Activate a Product on Steam](/playtest/steam_activate.png)\r
\r
Once activated, you can download and launch the game like any other title.\r
\r
---\r
\r
## Getting Started\r
\r
### Objective\r
Defend each region of the **Empyrean Realm** against Zharos’ invading forces.  \r
Build, upgrade, and strategically manage your defense sites to survive each wave.\r
\r
### Core Gameplay Loop\r
1. **Build Sites** - Choose from military, economy, power, or support sites.\r
2. **Defend Against Waves** - Enemy units advance along the map paths.\r
3. **Earn Credits** - Defeating enemies and maintaining economy sites provides income.\r
4. **Upgrade & Adapt** - Reinforce key sites to counter tougher enemy units.\r
\r
 \r
![Gameplay Overview](/playtest/gameplay.png)\r
\r
---\r
\r
## Basic Controls\r
...
## FAQ\r
\r
**Q: What settings can I change to improve performance or framerate?**\r
A: For the best performance on most systems, open the **Settings** menu and navigate to the **Display** tab. Try disabling **Glow** and **Dynamic Shadows**, and lowering **Quality**, **Environment Draw Distance**, **Environment Detail**. You may also see improvement by running the game in **Windowed Mode** instead of Fullscreen.\r
\r
**Q: Is my progress saved between sessions?**  \r
A: Yes - your save data is stored locally and synced via Steam Cloud to persist across devices and sessions.\r
\r
**Q: Can I stream or record gameplay?**  \r
A: Yes, feel free to share footage publicly and tag **#EmpyreanDefense** on social media.\r
\r
**Q: How do I report bugs or feedback?**  \r
A: Join the Empyrean Defense Discord (shared privately) to submit any bugs or suggestions.\r
\r
**Q: Will my progress carry over to Early Access?**  \r
A: Not guaranteed - progress may reset as the game evolves during development.\r
\r
**Q: How long will the Playtest run?**  \r
A: Playtest sessions are open for a limited time. Check announcements on Discord or Steam for dates.\r
\r
---\r
\r
...
\r
Get updates, share feedback, and connect with other players:  \r
- **Discord:** Shared Privately  \r
- **Official Website:** [Nighthawk Studios](https://www.nighthawk-studios.com)\r
- **Instagram:** [nighthawk.studios](https://www.instagram.com/nighthawk.studios/)\r
\r
---\r
\r
