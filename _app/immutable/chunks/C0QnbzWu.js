...
# LNG Cargo Vessel\r
\r
This massive liquefied natural gas (LNG) cargo vessel is not a frontline warship, but its strategic value makes it a priority target. Reinforced for long haul transport, the vessel carries five pressurized LNG containment tanks along its deck. Each tank represents a volatile weak point: breaching them destabilizes the ship and prevents its cargo from reaching enemy staging areas farther north.\r
\r
## Stats\r
- Health: 150000 hp\r
- Speed: 2 m/s\r
...
## Drops\r
\r
### Items drop table roll chance: 100%\r
\r
...
\r
\r
### Site drop table roll chance: 65%\r
\r
...
\r
### Skill points drop table roll chance: 65%\r
\r
Skill point: 1 / 4096\r
\r
### Rare items drop table roll chance: 65%\r
\r
| Icon | Name | Type | Description | Drop Chance | Value | Amount |\r
|:----------:|:----------:|:----------:|:----------:|:----------:|:----------:|:----------:|\r
